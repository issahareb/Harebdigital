      ...
      {HD_SPRACHEN.map((l) => {
        ...
        return (
          <button
            ...
            onClick={() => umstellen(l)}
            className={`hd-sprachschalter-knopf min-h-7 rounded-full px-2 font-label text-[11px] font-medium uppercase tracking-[0.08em] transition-colors sm:min-h-8 sm:px-2.5 sm:text-[12px] sm:tracking-[0.1em] ${
              aktiv
